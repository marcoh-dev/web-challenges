...
switchValueButton.addEventListener("click", () => {
  const firstSwitchValueInputValue = firstSwitchValueInput.value;
  const secondSwitchValueInputValue = secondSwitchValueInput.value;
  firstSwitchValueInput.value = secondSwitchValueInputValue;
  secondSwitchValueInput.value = firstSwitchValueInputValue;
});
// --^-- End of Task 3 --^--
